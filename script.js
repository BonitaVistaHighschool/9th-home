...
var upgrades = [
	{name:'Bank',price:1,dec:'Earn 50€ more when offline',priceboost:1},
	{name:'Offline Production',price:1,dec:'Earn offline money faster',priceboost:1},
	{name:'+CASH',price:1,dec:'Get more cash per click',priceboost:1},
	{name:'Luck',price:1,dec:'Higher chance of opening good skins',priceboost:1},
	{name:'Online Production',price:1,dec:'+0.10€ every secound',priceboost:1}
]
var classesType1 = {
...
function clickCookie(e) {
	var a = Math.random() * (1000 + userdata.upgrades['+CASH'].amount);
